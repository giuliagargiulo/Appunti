...
public:
  ...
  // Comparison operators
  bool operator == (const BTPostOrderMutableIterator & other) const noexcept { BTPostOrderIterator<Data>::operator ==(other);};
...
public:
  ...
  // Comparison operators
  bool operator == (const BTBreadthMutableIterator & other) const noexcept { BTBreadthIterator<Data>::operator ==(other);};
